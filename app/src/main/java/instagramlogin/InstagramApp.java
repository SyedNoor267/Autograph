...
public class InstagramApp implements Serializable {
    ...
    public static String mCallbackUrl = "http://www.networkips.com/";
    ...
    public InstagramApp(Context context, String clientId, String clientSecret,
        ...
        InstagramDialog mDialog = new InstagramDialog(context, mAuthUrl, listener);
